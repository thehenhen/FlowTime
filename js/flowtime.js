    class FlowTime{
        constructor(){
            ...
            this.breakStartHour=getItem('breakStartHour')||0;
            this.breakStartMin=getItem('breakStartMin')||0;
            this.breakStartSec=getItem('breakStartSec')||0;
            this.breakStartTotal=this.breakStartHour*3600+this.breakStartMin*60+this.breakStartSec;

            this.breakCurrentTotal=hour()*3600+minute()*60+second();

            this.totalBreak=getItem('totalBreak')||0;
        ...
        showWorking(){
            this.total=hour()*3600+minute()*60+second()-this.totalBreak;
        ...
        showBreak(){
            this.breakCurrentTotal=hour()*3600+minute()*60+second();
            this.breakTimer=this.breakCurrentTotal-this.breakStartTotal;
            storeItem('breakTimer',this.breakTimer);
            console.log(this.breakTimer+" "+this.breakCurrentTotal+" "+this.breakStartTotal);
